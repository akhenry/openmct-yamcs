...
const typeMap = {
    ...
    [OBJECT_TYPES.EVENT_SPECIFIC_OBJECT_TYPE]: DATA_TYPES.DATA_TYPE_EVENTS,
    [OBJECT_TYPES.EVENT_SPECIFIC_SEVERITY_OBJECT_TYPE]: DATA_TYPES.DATA_TYPE_EVENTS,
...
function isEventType(type) {
    return [OBJECT_TYPES.EVENTS_ROOT_OBJECT_TYPE, OBJECT_TYPES.EVENT_SPECIFIC_OBJECT_TYPE, OBJECT_TYPES.EVENT_SPECIFIC_SEVERITY_OBJECT_TYPE].includes(type);
}
